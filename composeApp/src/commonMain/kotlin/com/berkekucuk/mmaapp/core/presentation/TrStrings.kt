...
val TrStrings = AppStrings(
    ...
    emptyMainCardFights = "Ana kartta maç bulunamadı",
    emptyPrelimFights = "Ön maçlarda maç bulunamadı",
    fightDetailLabelName = "İsim",
    fightDetailLabelAge = "Maştaki Yaş",
    fightDetailLabelHometown = "Temsilci",
    fightDetailLabelHeight = "Boy",
    fightDetailLabelReach = "Erişim",
    ...
    fighterDetailResultWin = "G",
    fighterDetailResultLoss = "Y",
    fighterDetailResultDraw = "B",
    fighterDetailResultNoContest = "İP",
